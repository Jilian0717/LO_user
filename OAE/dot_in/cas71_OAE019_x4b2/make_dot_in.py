...
his_interval = 86400 # 3600 # seconds to define and write to history files
...
# DERIVED VALUES
if multi_core:
    if Ldir['np_num'] == 160: # for new mox nodes 2*32=64 2019_02
...
D['dstart'] = int(Lfun.datetime_to_modtime(fdt) / 86400.) - 1 #jx: "-1" is used to enable ROMS to save ocean_avg under the situation of restart; otherwise, the model will ask for ocean_avg_0001.nc
