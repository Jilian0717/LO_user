...
Oxy_pro_spatial = np.zeros((24*32, NX, NY)) # initialize array, 24*32 > 24 days of hourly output
...
#dict_tmp = {'t': t, 
#            'Oxy_pro_sum': Oxy_pro_sum, 
#            'Oxy_nitri_sum': Oxy_nitri_sum,
#            'Oxy_remi_sum': Oxy_remi_sum,
#            'Oxy_sed_sum': Oxy_sed_sum,
#            'Oxy_vol_sum': Oxy_vol_sum,
#            'Oxy_pro_spatial': Oxy_pro_spatial, 
#            'Oxy_nitri_spatial': Oxy_nitri_spatial,
#            'Oxy_remi_spatial': Oxy_remi_spatial,
#            'Oxy_sed_spatial': Oxy_sed_spatial,
#            }
#pickle.dump(dict_tmp, open("oxy_pro_con_"+ds0+'_'+Ldir['gtagex']+'.p','wb'))
#%% save
